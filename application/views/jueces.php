      ...
      <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-collapse collapse sidebar-navbar-collapse" align="center">
          <ul class="nav navbar-nav" align="center">
            ...
            <li class="active" align="center"><a align="center" href="<?php echo base_url('')?>">Menu Jueces</a></li>
...
<ul class="nav navbar-nav">
  ...
  <div class="col-md-9 col-md-push-1" style=" background-color: #fff8dc;">
    ...
    <h3 align="center" class="bg-primary">Modulo Jueces</h3>
    <br />
    <button class="btn btn-success" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i> Modificar Jueces</button>
    <br />
    <br />

    <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%" style=" background-color: #fff8dc;">
      <thead>
        <tr >
          <th>Dni</th>
          <th>Nombres</th>
...
<div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="ubigeo_idUbigeo" placeholder="departamento" class="form-control" type="text">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="LenguasNativos_idLenguaNativo" placeholder="Lengua Nativa" class="form-control" type="text">
              </div>
            </div>
             ...
             <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="NivelesInstruccion_idNivelInstruccion" placeholder="nivel de instruccion" class="form-control" type="text">
              </div>
            </div>
